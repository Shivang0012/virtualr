...
const Createaccount = ({ COpen ,closeCModal }) => {
    ...
    return (
        <div className='fixed inset-0 backdrop-blur-sm bg-opacity-50 flex justify-center items-center z-50 '>
            <div className='bg-neutral-600 p-6 rounded-lg shadow-xl w-96 relative'>
                <button onClick={ closeCModal } className="absolute top-3 right-3 hover:text-gray-400"><X /></button>
                <h2 className='font-semibold text-2xl text-center mb-4 text-neutral-400 '>Create
                </h2>
                <form action="#">
                    <div className="mb-6">
                    ...
                    <div className="text-sm text-center">
                        <h6>Don't have an account ? <span className="font-semibold hover:text-gray-400">Login</span></h6>
                    </div>
